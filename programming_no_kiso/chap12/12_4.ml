...
(* 整列済みのekimei_t型のリストとekimei_t型のデータを受け取ったら，ekimei_t型を挿入する *)
(* ekimei_insert : ekimei_t list -> ekimei_t -> ekimei_t list *)
let rec ekimei_insert lst eki = match lst with
    [] -> [eki]
  | ({kanji = lst_k; kana = lst_ka; romaji = lst_r; shozoku = lst_s} as first) :: rest ->
     match eki with
       {kanji = eki_k; kana = eki_ka; romaji = eki_r; shozoku = eki_s} ->
       if eki_ka < lst_ka then eki :: lst
       else if eki_ka = lst_ka then lst
       else first :: eki :: rest;;

(* テスト *)
let test1 = ekimei_insert global_ekimei_list {kanji="嗚呼";kana="ああ";romaji="aa";shozoku="便線"}
            =  [
      {kanji="嗚呼";kana="ああ";romaji="aa";shozoku="便線"};
      {kanji="代々木上原"; kana="よよぎうえはら"; romaji="yoyogiuehara"; shozoku="千代田線"}; 
      {kanji="代々木公園"; kana="よよぎこうえん"; romaji="yoyogikouen"; shozoku="千代田線"}; 
      {kanji="明治神宮前"; kana="めいじじんぐうまえ"; romaji="meijijinguumae"; shozoku="千代田線"}; 
      {kanji="表参道"; kana="おもてさんどう"; romaji="omotesandou"; shozoku="千代田線"}; 
...
(* テスト *)
let test2 = seiretsu [{kanji="嗚呼";kana="ああ";romaji="aa";shozoku="便線"};
                       {kanji="代々木上原"; kana="よよぎうえはら"; romaji="yoyogiuehara"; shozoku="千代田線"}; 
                       {kanji="代々木公園"; kana="よよぎこうえん"; romaji="yoyogikouen"; shozoku="千代田線"}; 
                       {kanji="明治神宮前"; kana="めいじじんぐうまえ"; romaji="meijijinguumae"; shozoku="千代田線"}]
            = [{kanji="嗚呼";kana="ああ";romaji="aa";shozoku="便線"};
